  ...
  const oldData = () => {
    return (
      <div className="w-full h-full bg-white flex flex-col">
        <div>
          <button className="confirm" onClick={() => setSelected(null)}>
            Back to History
          </button>
        </div>
  ...
  return (
    <div className="w-full h-full mt-5 bg-gray-100 gap-1 flex">
      ...
      <div className="w-full flex flex-col h-full">
        <div
          className={` p-0.5 h-full flex flex-col rounded-lg shadow-xl transition-transform duration-500 ${
            !showHistory ? "hidden" : "transform translate-y-1"
          }`}
        >
          <h1>History</h1>
          <div className="h-5/6">
        ...
        <div
          className={`p-0.5 h-full transition-transform duration-75 ${
            showHistory
              ? "transform translate-y-11 opacity-50 pointer-events-none"
              : ""
          }`}
        >
          <div className="h-5/6">
